      ...
      <div>
        <HeroHighlight>
          <motion.h1
            ...
            className="text-3xl md:text-5xl lg:text-6xl font-bold text-gray-700 max-w-4xl leading-relaxed lg:leading-snug mx-auto "
          >
            ...
            >
              Press{' '}
              <span className=" bg-gray-100 border border-gray-300 rounded-[3px] px-[4px] pt-[3px]">
                D
              </span>{' '}
              to Download CV
            </Link>
        ...
        <div className="flex flex-col gap-8">
          <div className="w-[220px] h-[70px] rounded-[4px] shadow-[0px_3px_4px_0px_rgb(0,0,0,0.2)] flex items-center bg-neutral-100/90 cursor-pointer hover:shadow-[0px_2px_2px_0px_rgb(0,0,0,0.2)] transition-all ease-out duration-100">
            <div className="flex justify-center items-center flex-col leading-none bg-white h-[45px] w-[52px] ml-4 rounded-[4px] shadow-[inset_1px_1px_2px_2px_rgba(0,0,0,0.1)]">
              <p className="text-center text-[13px] font-light pt-[2px] mb-[2px]">
                {getCurrentMonth}
              </p>
          ...
          <Link
            href={'#'}
            className="underline underline-offset-4 text-gray-800 text-center text-sm font-medium"
          >
