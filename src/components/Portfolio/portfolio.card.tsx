  ...
  return (
    <>
      {cardDetails?.map((element, index) => (
        <div
          key={index}
          className={`p-5 w-[340px] transition-all duration-150 shadow-md shadow-violet-100 border border-gray-200 rounded-xl break-inside-avoid mb-6 mx-3 bg-white bg-opacity-90`}
        >
          <Image
          ...
          <div className="w-full leading-[22px] mt-4">
            ...
            <p className="w-full mt-2 text-md text-gray-400 font-light">
          ...
          <div className="flex gap-3 mt-5">
            <Button
              variant={'outline'}
              size={'sm'}
              className="text-gray-700 bg-purple-50 hover:bg-purple-100 font-medium border-violet-200/75"
            >
            ...
            <Button
              variant={'outline'}
              size={'sm'}
              className="font-medium text-gray-600 hover:bg-purple-50"
            >
