        ...
        <div className="flex flex-row justify-center gap-20 w-full mt-20">
          <div className="flex gap-12 tracking-wide">
            {Object.entries(stackData)?.map(([stack, details], index) => (
              <div key={index}>
                <div
                  key={`stack${index}`}
                  className="px-[60px] py-[30px] bg-gradient-to-r from-violet-200 to-purple-200 text-xl font-bold text-purple-900 rounded-lg"
                >
                  {stack}
                </div>
                <div key={`details${index}`} className="mt-8 rounded-md shadow-md">
                  {Object.entries(details)?.map(([keys, list], subIndex) => (
                    <div key={subIndex}>
                      ...
                      <ul
                        key={`data${subIndex}`}
                        className="list-inside list-disc py-3 pl-3 bg-purple-200/15 text-gray-600 leading-relaxed text-[15px]"
                      >
          ...
          <div className="w-[670px]">
            ...
            <p className="mt-6 text-lg leading-normal text-gray-600">
              ...
              focusing on delivering high-quality solutions. My expertise lies in a comprehensive
              range of technologies including JavaScript, TypeScript, React, Next.js, Node.js,
              Nest.js, Express, GraphQL and many more. With a deep understanding of these tools and
              frameworks, I excel in crafting dynamic and scalable full-stack applications that meet
              the evolving needs of modern businesses. Let me bring my wealth of experience and
              ...
              <div className="flex gap-6 mt-6">
                ...
                <div className="w-full">
                  <Link
                    ...
                    target="_blank"
                    className="text-xl font-semibold text-secondary-platform hover:underline"
                  >
                    Cloud Analogy
                  </Link>
                  ...
                  <ul className="list-disc list-inside text-gray-700 text-[15px]">
                    <li>
                      Leading the design and development team of multiple enterprise-level
                      applications.
                    </li>
                    <li>
                      Product security with penetration testing and reporting vulnerabilities.
                    </li>
                    <li>
                      Transformed UIs using React, decreasing debugging time by 61% and increasing
                      views by 33%.
                    </li>
                  </ul>
                  ...
                  <ul className="list-disc list-inside text-gray-700 text-[15px]">
                    <li>
                      Built scalable full stack architecture for multiple enterprise software
                      products.
                    </li>
            ...
            <div className="mt-8">
              ...
              <div className="flex gap-6 mt-6">
                ...
                <div className="w-full">
                  <Link
                    href={'https://www.iul.ac.in/Program/PG/PG_mca.aspx'}
                    target="_blank"
                    className="text-xl font-semibold text-secondary-platform hover:underline"
                  >
                  ...
                  <div className="flex justify-between items-center mb-2">
                    <Link
                      ...
                      target="_blank"
                      className="text-md font-normal text-gray-600 hover:underline"
                    >
                      Integral University
                    </Link>
              ...
              <div className="flex gap-6 mt-6">
                ...
                <div className="w-full">
                  <Link
                    href={'https://www.iul.ac.in/Program/UG/UG_BCA.aspx'}
                    target="_blank"
                    className="text-xl font-semibold text-secondary-platform hover:underline"
                  >
