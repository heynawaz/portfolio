  ...
  return (
    <>
      <section className="w-full mt-32 flex justify-center">
        <div className="flex items-center justify-center gap-20 shadow-sm w-full h-[50rem] px-20 bg-zinc-50">
          <div className="flex flex-col w-[800px]">
            ...
            <p className="w-[750px] mt-5 mb-10 text-lg leading-relaxed text-gray-500">
