...
export function Solutions() {
  return (
    <section id="portfolio" className="mt-36 flex justify-center flex-col w-full items-center mb-36 pt-28">
      <SectionHeader heading="Solutions Suite" description="Unlock a world of exceptional services tailored to your needs, ranging from full-stack wizardry to mesmerizing frontend design and powerhouse backend development." />
      ...
      <div className="flex gap-20 mt-36">
        ...
        <button className="bg-gradient-to-br from-[#5D23FF] to-[#AB01C7] rounded-full shadow-[inset_3px_3px_5px_1px_rgb(255,255,255,.5)] p-[16px] px-[42px] w-[220px] text-white font-medium pt-[20px]">Download CV</button>
      </div>
    </section>
  );
}
